...
@Component({
  selector: 'app-products-dairy',
  templateUrl: './products-dairy.component.html',
  styleUrls: ['./products-dairy.component.css']
})
export class ProductsDairyComponent implements OnInit {
  ...
  ngOnInit() {
    this.getDairyProducts();
  }

  getDairyProducts(): void {
    this.productService.getDairyProducts()
    .subscribe(products => this.dairyProducts = products);
  }
