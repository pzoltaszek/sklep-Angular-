...
@Component({
  selector: 'app-products-dairy-milk',
  templateUrl: './products-dairy-milk.component.html',
  styleUrls: ['./products-dairy-milk.component.css']
})
export class ProductsDairyMilkComponent implements OnInit {

  dairyMilkProducts: Product[];
  regular = /^[1-9]$|^[1-9]\d$/;

  constructor(private productService: ProductService, private cartService: CartService) { }

  ngOnInit() {
    this.getDairyMilkProducts();
  }

  getDairyMilkProducts(): void {
    this.productService.getDairyMilkProducts()
    .subscribe(products => this.dairyMilkProducts = products);
  }
