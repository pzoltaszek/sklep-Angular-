...
@Component({
  selector: 'app-products-vegetables',
  templateUrl: './products-vegetables.component.html',
  styleUrls: ['./products-vegetables.component.css']
})
export class ProductsVegetablesComponent implements OnInit {
  ...
  ngOnInit() {
    this.getVegetablesProducts();
  }

  getVegetablesProducts(): void {
    this.productService.getVegetablesProducts()
      .subscribe(products => this.vegetablesProducts = products);
  }
